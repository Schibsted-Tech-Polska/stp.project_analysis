...
mno.core.register({
    id: 'widget.reiseCarousel.default',
        ...
        function init() {
            if (sandbox.container) {
                sandbox.container.each(function (widgetIndex, element) {
                        ...
                        var customListId = getURLParameter('reiseCarouselId');
                        if (customListId !== null) {
                            model.carouselId = customListId;
                        }

                        categoryId = getURLParameter('reiseCategoryId');
                        ...
                        function fetchAds() {
                            ...
                            sandbox.getScript({
                                ...
                                callbackName: 'reiseDefault' + widgetIndex,
                                jsonP: onAdsLoaded,
                                error: onError
                            });
                            } catch (e) {
                        ...
                        function renderCategories() {
                            if (categories.length > 0) {
                                if (categoryId) {
                                    var $header = $carousel.find('div h2');
                        ...
                        function render() {
                            sandbox.render('widgets.reiseCarousel.views.reiseItem', {
                                items: dataGB,
