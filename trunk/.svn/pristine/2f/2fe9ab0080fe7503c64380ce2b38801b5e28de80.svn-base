<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-community-favoritesList/src/main/webapp/template/widgets/favoritesList/view/simple.jsp#2 $
...
--%>
<%-- this page renders the simple view of favoritesList widget--%>
