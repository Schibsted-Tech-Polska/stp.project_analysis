<%--
 * File           : $Header: //depot/projects/widget-framework/src/main/webapp/WEB-INF/tags/escenic-widget/present.tag#1 $
...
<%@ tag language="java"
        import="neo.xredsys.content.type.TypeManager, neo.xredsys.content.type.ArticleType" %>
