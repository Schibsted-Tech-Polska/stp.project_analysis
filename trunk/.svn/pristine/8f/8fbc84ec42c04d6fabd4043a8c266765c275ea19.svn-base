mno.core.register({
    id:'widget.storyContent.article',
    extend:['widget.storyContent.main'],
    creator:function (sandbox) {

        function init() {
            var model = sandbox.model;
            if (typeof mnoMobile === 'undefined') {
                this.initArticle(sandbox,this);
            }
            ...
            var storyContentBodyText = sandbox.container.find('.storyContent.bodyText'),
