<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-framework-core/src/main/webapp/template/framework/group/x620x300-config.jsp#1 $
...
<div id="page" class="x620x300-config">
