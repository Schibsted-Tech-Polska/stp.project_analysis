<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-core-weather/src/main/webapp/template/widgets/weather/index.jsp#1 $
...
<util:cache id="weather${weatherParamValue}${widgetContent.id}" expireTime="${cacheDuration}s">
  <%-- call wf-core:view tag to render the appropraite view of the widget --%>
  <wf-core:view widgetName="weather" />
</util:cache>
