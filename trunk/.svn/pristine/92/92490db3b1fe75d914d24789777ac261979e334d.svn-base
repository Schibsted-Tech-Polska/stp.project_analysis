<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-core-menu/src/main/webapp/template/widgets/menu/controller/helpers/horizontalAllSubitems.jsp#1 $
...
<util:profiler path="/template/widgets/menu/controller/helpers/horizontalAllSubitems.jsp">
  ...
  <c:forEach var="currentMenuItem" items="${parentMenuItemsList}" varStatus="menuItemStatus">
    ...
    <c:if test="${(menu.depth+0) > (currentDepth+0) and not empty currentMenuItem.menuItem.children}">
