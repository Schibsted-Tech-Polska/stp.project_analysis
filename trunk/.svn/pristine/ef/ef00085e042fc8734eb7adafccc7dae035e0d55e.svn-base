<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-core-slideshow/src/main/webapp/template/widgets/slideshow/controller/helpers/galleryAttributes.jsp#1 $
...
<c:set target="${slideshow}" property="slideshowDivId" value="slideshow-${widgetContent.id}"/>
  ...
  <c:if test="${loopStatus.first}">
    ...
    <c:choose>
      <c:when test="${image.width > 350}">
        ...
        <c:set target="${slideshow}" property="prevButtonUrl" value="${skinUrl}gfx/slideshow/left.png" />
        <c:set target="${slideshow}" property="nextButtonUrl" value="${skinUrl}gfx/slideshow/right.png" />
      ...
      <c:otherwise>
        ...
        <c:set target="${slideshow}" property="prevButtonUrl" value="${skinUrl}gfx/slideshow/left-small.png" />
        <c:set target="${slideshow}" property="nextButtonUrl" value="${skinUrl}gfx/slideshow/right-small.png" />
        <c:set target="${slideshow}" property="navStatusText">
