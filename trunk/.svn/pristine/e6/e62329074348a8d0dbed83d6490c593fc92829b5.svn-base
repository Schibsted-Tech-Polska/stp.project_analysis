<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-core-stories/src/main/webapp/template/widgets/stories/controller/topstory.jsp#1 $
...
<c:set target="${stories}" property="source" value="${fn:trim(widgetContent.fields.sourceTopstory.value)}"/>
<c:set target="${stories}" property="showSectionTitle" value="${fn:trim(widgetContent.fields.showSectionTitleTopstory.value)}"/>
<c:set target="${stories}" property="selectSectionName"
       value="${fn:trim(widgetContent.fields.selectSectionNameTopstory.value)}"/>
...
<c:set var="begin" value="${fn:trim(widgetContent.fields.beginTopstory.value)}"/>
<c:if test="${not empty begin and begin > 0}">
  <c:set var="begin" value="${begin-1}"/>
</c:if>
<c:set var="end" value="${fn:trim(widgetContent.fields.endTopstory.value)}"/>
...
<c:set target="${stories}" property="showComments" value="${fn:trim(widgetContent.fields.showCommentsTopstory.value)}" />
<c:set target="${stories}" property="imagePosition" value="${fn:trim(widgetContent.fields.imagePositionTopstory.value)}" />
<c:set target="${stories}" property="showCaption" value="${fn:trim(widgetContent.fields.showCaptionTopstory.value)}" />
<c:set target="${stories}" property="enableSlideshow" value="${fn:trim(widgetContent.fields.enableSlideshowTopstory.value)}" />
