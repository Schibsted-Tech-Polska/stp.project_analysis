...
%sendfiles = (
#	"btpub" => {
#		"server" => "btpub.medianorge.no",
#		"user" => "resin",
#		"dir" => "/data/import",
#		"imports" => "jobbChannel",
#	},
	"bttest" => {
		"server" => "bttest1.medianorge.no",
		"user" => "resin",
		"dir" => "/data/import",
		"imports" => "jobbChannel",
	},
	"fvntest" => {
		"server" => "fvntapp01.medianorge.no",
		"user" => "resin",
		"dir" => "/data/import",
		"imports" => "jobbChannel",
	},
	"fvnpub" => {
		"server" => "fvnpub.medianorge.no",
		"user" => "resin",
		"dir" => "/data/import",
		"imports" => "jobbChannel",
	},
	"brett1" => {
		"server" => "brett1.medianorge.no",
		"user" => "mno",
		"dir" => "/data/import",
		"imports" => "video",
	},
#	"sapub" => {
#		"server" => "sapub.medianorge.no",
#		"user" => "resin",
#		"dir" => "/data/import",
#		"imports" => "jobbChannel",
#	},
#	"satest" => {
#		"server" => "satest1.medianorge.no",
#		"user" => "resin",
#		"dir" => "/data/import",
#		"imports" => "jobbChannel",
#	},
...
%getfiles = (
	"jobbChannel" => {
		...
		"dir" => "/data/aft/eceXmlExport/jobbChannel",
	},
	"video" => {
		"user" => "resin",
		"host" => "aipub.aftenposten.no",
		"dir" => "/data/aft/eceXmlExport/iPadChannel",
	},
#	"jobbChannel" => {
#		"user" => "resin",
#		"host" => "aitest.aftenposten.no",
#		"dir" => "/usr/local/resin-2.1.16/webapps/Aftenposten/testExport",
#	},
);
# ========== END CONFIG ==========
