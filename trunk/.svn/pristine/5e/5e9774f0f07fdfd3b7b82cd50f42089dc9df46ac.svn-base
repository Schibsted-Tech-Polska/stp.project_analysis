<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-core-popularList/src/main/webapp/template/widgets/popularList/view/mostCommented.jsp#2 $
...
<%-- The purpose of this JSP page is to render the mostCommented view of popularList widget. --%>
