...
wget $wopt "$lurl?utf8=true&siteId=2&renderType=latestJobs&noOfAds=10" -O pubData/bt/jobLatestAll_flash.json
wget $wopt "$curl?utf8=true&siteId=3&adCountType=job&renderType=public&node=27&cb=cbJobCategories" -O pubData/sa/jobCategories.json
wget $wopt "$rurl&specialCategoryType=recruitingCompaniesSA&utf8=true&cb=cbRecruitingCompanies" -O pubData/sa/recruitingCompanies.json
wget $wopt "$lurl?utf8=true&siteId=3&renderType=latestJobs&noOfAds=10&cb=cbLatestJobsListAll" -O pubData/sa/jobLatestAll.json
wget $wopt "$lurl?utf8=true&siteId=3&renderType=latestJobs&noOfAds=10" -O pubData/sa/jobLatestAll_flash.json
...
do
	...
	scpme pubData/bt/jobLatestAll_flash.json syncdat@$server:$ddir/
done
for server in $sa5prod
do
	#ssh syncdat@$server "mkdir -p $ddir"
	scpme pubData/sa/recruitingCompanies.json syncdat@$server:$ddir/
	scpme pubData/sa/jobCategories.json syncdat@$server:$ddir/
	scpme pubData/sa/jobLatestAll.json syncdat@$server:$ddir/
	scpme pubData/sa/jobLatestAll_flash.json syncdat@$server:$ddir/
done
