<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-core-popularList/src/main/webapp/template/widgets/popularList/controller/mostEmailed.jsp#1 $
...
<%-- This is the controller of the mostEmailed view of popularList widget --%>
...
<c:set target="${popularList}" property="showCount" value="${fn:trim(widgetContent.fields.showCountEmail)}" />
