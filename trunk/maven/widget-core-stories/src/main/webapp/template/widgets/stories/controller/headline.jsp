<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-core-stories/src/main/webapp/template/widgets/stories/controller/headline.jsp#1 $
...
<c:set target="${stories}" property="showSectionTitle" value="${fn:trim(widgetContent.fields.showSectionTitleHeadline.value)}"/>
<c:set target="${stories}" property="selectSectionName"
       value="${fn:trim(widgetContent.fields.selectSectionNameHeadline.value)}"/>
...
<c:set var="begin" value="${fn:trim(widgetContent.fields.beginHeadline.value)}"/>
<c:if test="${not empty begin and begin > 0}">
  <c:set var="begin" value="${begin-1}"/>
</c:if>
<c:set var="end" value="${fn:trim(widgetContent.fields.endHeadline.value)}"/>
...
<c:set target="${stories}" property="headingSize" value="${fn:trim(widgetContent.fields.headingSizeHeadline.value)}" />
<c:set target="${stories}" property="showComments" value="${fn:trim(widgetContent.fields.showCommentsHeadline.value)}" />
