<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-framework-core/src/main/webapp/template/framework/group/x140x460x300-config.jsp#1 $
...
<div id="outer" class="x140x460x300-extended-config">
...
<div id="page" class="x140x460x300-extended-config">
  ...
  <div id="content"> <!--pageBody-->
    <div id="areas">
      ...
      <div id="left">
        <c:set var="currentAreaName" value="left" scope="request" />

        <c:set var="area" value="left" scope="request" />
        <jsp:include page="getitems.jsp" />
        <c:remove var="area" scope="request" />
      ...
      <div id="main"> <!--mainContent-->
        ...
        <c:set var="elementwidth" value="460" scope="request"/>
