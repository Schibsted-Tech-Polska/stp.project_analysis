<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-framework-core/src/main/webapp/template/framework/errorpages/generalError.jsp#1 $
...
<div class="error-page">
  ...
  <p class="title">An unexpected error occurred</p>
