<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-framework-core/src/main/webapp/template/framework/group/x940-extended-config.jsp#1 $
...
<div id="outer" class="x940-extended-config">
...
<div id="page" class="x940-extended-config">
