<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-mobile-mobileMenu/src/main/webapp/template/widgets/mobileMenu/index.jsp#1 $
...
<util:cache id="mobileMenu-cache-${view}-view-${widgetContent.id}" expireTime="${updateInterval}m" includeSection="${true}">
  <wf-core:view widgetName="mobileMenu"/>
</util:cache>
