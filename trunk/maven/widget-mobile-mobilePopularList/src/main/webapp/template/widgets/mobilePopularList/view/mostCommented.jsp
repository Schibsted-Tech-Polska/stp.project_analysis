<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/1.4/widget-mobile-mobilePopularList/src/main/webapp/template/widgets/mobilePopularList/view/mostCommented.jsp#2 $
...
--%>
<%-- The purpose of this JSP page is to render the mostCommented view of mobilePopularList widget. --%>
