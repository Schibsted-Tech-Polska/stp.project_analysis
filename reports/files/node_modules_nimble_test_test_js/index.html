...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/nimble/test/test.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="span12">(function (exports) {
...
}(typeof exports === 'undefined' ? this.test_nimble = {}: exports));</textarea>
  </div>
</div>
