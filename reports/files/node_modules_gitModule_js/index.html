...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/gitModule.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="span12">var exec = require('child_process').exec;


exports.cloneRepo = function(link,callback){
	
	exec('git clone ' + link,
		function (error, stdout, stderr) {
			console.log("-->before callback in gitClone");
			callback();
		});
	//return linkToFile;//{
	//while(true){
