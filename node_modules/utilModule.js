...
exports.copyFileAndChangeProperties = function(source, target,propertiesToChange, cb ){
   var data = readTextFileAndModifyContent(source,target,propertiesToChange, writeTextFile);
