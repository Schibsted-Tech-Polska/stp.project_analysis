...
function PropertiesGenerator(language, projectLocation, filesToOmit){
	this.coma=",";
	...
	if(language=='js'){
		this.parameters.filesToOmit = jsFilesToOmit.getFiles().concat(filesToOmit.split(this.coma));
	}else{
		var emptyArray =[];
        var filesTypedByUser = filesToOmit.split(this.coma);
    	var afterConcat = emptyArray.concat(filesTypedByUser);
    	console.log("after concat : " + afterConcat);
    	this.parameters.filesToOmit = afterConcat;
	}
}
...
function generatePropertiesFile(properties ,propertiesToChange, callback) {
	...
	var propertiesGenerator = new PropertiesGenerator(language, projectLocation,properties.filesToOmit);
